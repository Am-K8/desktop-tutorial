  ...
  if ($result) {
    if (mysqli_num_rows($result) > 0) { //email or username already taken
     ...
     //password hasing
      ...
      //data insert
      $query = "INSERT INTO `user`(`fname`, `lname`, `email`, `phone`, `password`, `verification_code`, `is_verified`) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[phone]','$password','$v_code','0')";
